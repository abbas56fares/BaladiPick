...
@section('title', 'Pickup Delivery Drivers')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                <h4 class="mb-0"><i class="bi bi-truck"></i> Pickup Delivery Drivers</h4>
            </div>
            <div class="card-body">
                <!-- Stats Cards -->
                <div class="row mb-4">
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $totalPickupDrivers }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $verifiedPickupDrivers }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $totalPickupOrders }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $deliveredPickupOrders }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.deliveries.pickups') }}" method="GET" class="mb-4">
                    <div class="row g-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($delivery->id_document_path)
                                                <a href="{{ asset('storage/' . $delivery->id_document_path) }}" target="_blank" class="btn btn-xs btn-info"><i class="bi bi-eye"></i></a>
                                            @else
                ...
                @else
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle"></i> No pickup delivery drivers found.
                    </div>
                @endif
            </div>
        </div>
