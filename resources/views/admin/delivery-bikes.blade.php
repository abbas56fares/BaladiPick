...
@section('title', 'Bike Delivery Drivers')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                <h4 class="mb-0"><i class="bi bi-bicycle"></i> Bike Delivery Drivers</h4>
            </div>
            <div class="card-body">
                <!-- Stats Cards -->
                <div class="row mb-4">
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $totalBikeDrivers }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $verifiedBikeDrivers }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3 mb-3 mb-md-0">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $totalBikeOrders }}</h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-md-3">
                        <div class="card bg-light">
                            <div class="card-body p-3">
                                ...
                                <h3 style="font-size: 1.5rem;">{{ $deliveredBikeOrders }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.deliveries.bikes') }}" method="GET" class="mb-4">
                    <div class="row g-2">
                ...
                @else
                    <div class="alert alert-info">
                        <i class="bi bi-info-circle"></i> No bike delivery drivers found.
                    </div>
                @endif
            </div>
        </div>
