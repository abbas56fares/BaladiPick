...
return [
    ...
    */
    ...
    | applications on your network. When an event is broadcast, Laravel will
    | determine which connection(s) to use and broadcast appropriately.
    |
    */
    ...
    'connections' => [
        ...
        'pusher' => [
            ...
            'options' => [
                ...
                'encrypted' => true,
                'useTLS' => env('PUSHER_USERTLS', true),
            ],
            'client_options' => [
